...
public class IndexedMapAttributeHolder implements AttributeHolder {
    ...
    public void copyFrom(final AttributeHolder srcAttributes) {
        ...
        if (srcAttributes instanceof IndexedMapAttributeHolder) {
            final IndexedMapAttributeHolder imah = (IndexedMapAttributeHolder) srcAttributes;
    ...
    public void copyTo(final AttributeHolder dstAttributes) {
        ...
        if (dstAttributes instanceof IndexedMapAttributeHolder) {
            final IndexedMapAttributeHolder imah = (IndexedMapAttributeHolder) dstAttributes;
            imah.valueMap.clear();
    ...
    private final class IndexedAttributeAccessorImpl implements IndexedAttributeAccessor {
        ...
        public Object getAttribute(final int index, final NullaryFunction initializer) {
            return valueMap.computeIfAbsent(index, k -> initializer != null ? initializer.evaluate() : null);
        }
